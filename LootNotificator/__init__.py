...
class Lootbeams(bl2sdk.BL2MOD):
    ...
    Description = "Adds Special Particles to all Red Text gear. Also plays a sound. Exodus and Reborn."
    Author = "Juso"
    SettingsInputs = {"Enter": "Exodus"}
    _Exodus = False
    _Reborn = False
    def SettingsInputPressed(self, name):
        if name == "Exodus":
            ...
            self.SettingsInputs = { 'Enter': "Exodus" }
            self.Enable()
